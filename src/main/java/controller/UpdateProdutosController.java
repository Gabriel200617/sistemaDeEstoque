...
@WebServlet("/UpdateProdutos")
public class UpdateProdutosController extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, 
            ...
            UpdateProdutoDAO dao = new UpdateProdutoDAO();
            boolean atualizar = dao.atualizar(produto);
            ...
            if(atualizar){
                ...
                response.sendRedirect("pages/gerenciamento.html");
            }else {
                System.out.println("ERRO no update ou no monitoramento");
            }
